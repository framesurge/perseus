...
> Perseus v0.3.0 is still in beta, and you'll need to explicitly specify the latest version (0.3.0-beta.2) in your `Cargo.toml` and when you install the CLI by using the `--version` flag.
